import { B as b, r as Z } from "./index-DVJv-V4L.js";
import { c as l } from "./index-nEdLvayB.js";
typeof window < "u" && (window.Buffer = window.Buffer || b);
class d extends l.Client {
  options;
  static async deploy({ owner: A }, G) {
    return l.Client.deploy({ owner: A }, G);
  }
  constructor(A) {
    (super(
      new l.Spec([
...
const c = new d({
  ...
  contractId: "CCNCGSY3QTZPLLTX6MEKFKNZOE2QT4QAJSI4EONVPYVNZF26OICTOGVY",
  rpcUrl: Z,
  allowHttp: !0,
  publicKey: void 0,
});

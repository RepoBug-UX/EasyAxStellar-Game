import { B as b, r as W } from "./index-DVJv-V4L.js";
import { c as G } from "./index-nEdLvayB.js";
typeof window < "u" && (window.Buffer = window.Buffer || b);
class d extends G.Client {
  options;
  static async deploy({ owner: A, initial_supply: l }, Z) {
    return G.Client.deploy({ owner: A, initial_supply: l }, Z);
  }
  constructor(A) {
    (super(
      new G.Spec([
        "AAAABAAAAAAAAAAAAAAAFEV4YW1wbGVDb250cmFjdEVycm9yAAAAAQAAAAAAAAAMVW5hdXRob3JpemVkAAAAAQ==",
...
const V = new d({
  ...
  contractId: "CDDONG6X7RAGKX23QHHBCKVZUPKFCAY6LCRZVJYI6RGMMIEGIRMSMBEO",
  rpcUrl: W,
  allowHttp: !0,
  publicKey: void 0,
});
